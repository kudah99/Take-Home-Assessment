...
return [
    ...
    */
    ...
    | keep sessions from lasting forever, giving you more security.
    |
    */
    ...
    | like normal. This means you will not have to encrypt them
    | yourself in any way.
    |
    */
    ...
    */
    ...
    | dictates which cache store will be used for your session data.
    |
    */
    ...
    */
    ...
    | driver that manages sessions backed by cookies.
    |
    */
